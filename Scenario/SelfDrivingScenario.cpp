...
#include "SelfDrivingScenario.h"
#include "../Operators/SelfDrivingOperator.h"

void SelfDrivingScenario::setUp() {
    ...
    world->add_object(r);
    RobotOperator *ro = new SelfDrivingOperator(r, mapName, false);
